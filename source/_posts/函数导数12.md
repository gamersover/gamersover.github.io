...
证：如果$D$是凸区域，则由[定理1](https://gamersover.github.io/2021/04/21/函数导数12/#定理1)立即得出结论。如果$D$不是凸区域，任取$\boldsymbol{x}_0 \in D$，令
$$
    \begin{aligned}
...
$$
    ...
    \end{aligned}
$$
根据[定理4](https://gamersover.github.io/2021/04/21/函数导数12/#定理4)可知，
$$
...
证：由[定理5](https://gamersover.github.io/2021/04/21/函数导数12/#定理5：Taylor公式)可知
$$
...
$$
由[定理7](https://gamersover.github.io/2021/04/21/函数导数12/#定理7：拟微分平均值定理)可知存在$\tau \in (0, 1)$，使得
$$
