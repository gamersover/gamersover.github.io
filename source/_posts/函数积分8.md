...
证：必要性。由[定理5](#定理5)可知，要证明$D(f)$是零测集，只需证明$D_{1/n}$是零测集，由于$f$在$I$上可积，从而对任意的$\varepsilon > 0$，存在$I$的一个分割$\pi = \{ I_1, I_2, \cdots, I_m \}$，使得
$$
...
$$
由[定理6](#定理6)可知，对上述的$\varepsilon > 0$，存在$\delta > 0$，使得当$\boldsymbol{x} \in K, \boldsymbol{y} \in I$，且$\Vert \boldsymbol{x} - \boldsymbol{y} \Vert < \delta$时，有
$$
...
证：不妨设$g$在$I$上可积，零$h = f - g$，由[定理8](#定理8)可知，$h$在$I$上可积，且
$$
