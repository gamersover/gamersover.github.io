...
$55. $ 直角$\triangle ABC$中，$\angle C = 90^\circ$，作$\displaystyle BN \perp BC, BN=AN, BD=\frac{1}{4}BA$，连接$ND$至点$M$，使得$MD=ND$，<br />
（1）证明$BM \perp AB$；<br />
...
（1）点$P$是线段$DF$的中点，连接$PG,PC$，探究$PG$与$PC$的位置和数量关系？$\displaystyle \frac{PG}{PC}$的值； <br/>
