...
（2）对$x>0$，均有$\displaystyle f(f(x)+\frac{1}{x})=1$ <br/>
求$f(1)$。
...
$97. $ 已知$Rt\triangle ABC$中, $\angle A = 90^\circ, AB = 1, BC=2$，$D$为$BC$的中点，将$\triangle ABD$沿$AD$折起，使点$B$在面$ADC$所在平面的投影$E$在$AC$上；<br/>
