...
$32. $ 已知一簇椭圆$C_n: x^2 + \frac{y^2}{b_n^2} = 1, 0 < b_n < 1, n=1,2,\cdots$，若椭圆$C_n$上有一点$P_n$，使得$P_n$到右准线$l_n$的距离$d_n$是$|P_nF_n|$与$|P_nG_n|$的等差中项，其中$F_n, G_n$是$C_n$的左右焦点；<br/>
（1）试证$b_n \le \frac{\sqrt 3}{2} (n \ge 1)$ <br/>
（2）取$b_n = \frac{\sqrt {2n + 3}}{n+2}$，并用$S_n$表示$\triangle P_nF_nG_n$的面积，试证$S_1 < S_2$，且$S_n > S_{n+1} (n \ge 3)$
